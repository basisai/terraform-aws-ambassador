...
| <a name="input_l7_logging_prefixes"></a> [l7\_logging\_prefixes](#input\_l7\_logging\_prefixes) | Prefixes you want to include in the resource policy for the bucket | `list(string)` | <pre>[<br>  "ambassador"<br>]</pre> | no |
